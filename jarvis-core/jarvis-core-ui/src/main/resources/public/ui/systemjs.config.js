(function(global) {
  ...
  var materialsVer = '@2.0.0-alpha.8-2'; // materials
  ...
  var  map = {
    ...
    // AngularMd for angular2
    'materials-core':             'https://unpkg.com/@angular2-material/core' + materialsVer,
    'materials-button':           'https://unpkg.com/@angular2-material/button' + materialsVer,
 };
