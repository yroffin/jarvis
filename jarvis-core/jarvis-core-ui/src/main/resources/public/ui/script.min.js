...
link:function(a,b,e){}}}]).directive("jarvisConfiguration",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/configuration/partials/jarvis-configuration-general.html",link:function(b,c,e){a.debug("jarvis-configuration")}}}]);"use strict";
angular.module("jarvis.directives.connector",["JarvisApp.services"]).controller("connectorsCtrl",["$scope","$log","genericScopeService","jarvisWidgetConnectorService",function(a,b,d,c){d.scope.resources(function(b){a.connectors=b},function(){return a.connectors},a,"connectors",c.connector,{name:"connector name",icon:"settings_input_antenna",isRenderer:!1,isSensor:!1,canAnswer:!1})}]).controller("connectorCtrl",["$scope","$log","$stateParams","$mdDialog","genericResourceService","genericScopeService",
"jarvisWidgetConnectorService","toastService",function(a,b,d,c,e,g,f,h){g.scope.resource(a,"connector","connectors",f.connector);a.ping=function(b){f.connector.task(b.id,"ping",b,function(b){a.status=angular.toJson(b,!0)},h.failure)};a.load=function(){e.scope.entity.get(d.id,function(b){a.connector=b},f.connector);b.info("connector-ctrl",a.connectors)}}]).factory("jarvisWidgetConnectorService",["genericResourceService",function(a){return{connector:a.crud(["connectors"])}}]).directive("jarvisWidgetConnectors",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/jarvis-widget-connectors.html",link:function(a,b,e){}}}]).directive("jarvisConnectors",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/partials/jarvis-connectors.html",link:function(a,b,e){}}}]).directive("jarvisWidgetConnector",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/jarvis-widget-connector.html",
link:function(a,b,e){}}}]).directive("jarvisConnectorGeneral",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/partials/jarvis-connector-general.html",link:function(a,b,e){}}}]);
