...
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/command/partials/jarvis-command-output.html",link:function(b,c,e){a.debug("jarvis-command-output")}}}]);
angular.module("jarvis.directives.navigator",["JarvisApp.services"]).controller("jarvisWidgetNavigatorCtrl",["$scope","$log","$stateParams",function(a,b,d){a.resources=d.resources;a.answer=function(a){a.callback(a)}}]).factory("jarvisWidgetNavigatorService",["$q","$location","snapshotResourceService","blockResourceService","jarvisWidgetConfigurationService","propertyResourceService","viewResourceService","jarvisWidgetTriggerService","scenarioResourceService","cronResourceService","connectorResourceService",
...
link:function(a,b,e){}}}]).directive("jarvisConnectorGeneral",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/partials/jarvis-connector-general.html",link:function(a,b,e){}}}]);"use strict";
