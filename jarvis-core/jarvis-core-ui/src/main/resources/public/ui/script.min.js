angular.module("JarvisApp","ngMaterial ngMdIcons ngSanitize restangular angular-websocket ui.router ui.router.router pascalprecht.translate ngCookies hljs ui.tree JarvisApp.websocket JarvisApp.config JarvisApp.theme JarvisApp.routes JarvisApp.services JarvisApp.services.filter JarvisApp.services.generic JarvisApp.services.scope JarvisApp.services.plugin JarvisApp.services.scenario JarvisApp.services.snapshot JarvisApp.services.view JarvisApp.services.property JarvisApp.services.device JarvisApp.services.event JarvisApp.services.block JarvisApp.directives.files JarvisApp.directives.widgets jarvis.directives.navigator jarvis.directives.command jarvis.directives.cron jarvis.directives.trigger jarvis.directives.configuration jarvis.directives.notification jarvis.directives.connector JarvisApp.ctrl.plugins JarvisApp.ctrl.devices JarvisApp.ctrl.events JarvisApp.ctrl.snapshots JarvisApp.ctrl.views JarvisApp.ctrl.properties JarvisApp.ctrl.scenarios JarvisApp.ctrl.blocks JarvisApp.ctrl.home".split(" "));
...
angular.module("JarvisApp.services.generic",["JarvisApp.services.filter"]).factory("genericResourceService",["$log","Restangular","filterService","toastService",function(a,b,d,c){var e={findAll:function(f,c,e){var g=function(b){var e=[];_.forEach(b,function(a){e.push(d.plain(a))});a.debug("[FIND]",f,e);c&&c(e)};1==f.length?b.all("/api/"+f[0]).getList().then(g,function(a){e(a)}):b.all("/api/"+f[0]).all(f[1]).getList().then(g,function(a){e(a)})},get:function(f,c,e,g){var k=function(b){b=d.plain(b);
a.debug("[GET]",f,b);void 0!=e&&e(b)};1==f.length?b.one("/api/"+f[0],c).get().then(k,function(a){g(a)}):b.all("/api/"+f[0]).one(f[1],c).get().then(k,function(a){g(a)})},delete:function(f,c,e,g){var k=function(b){b=d.plain(b);a.debug("[DELETE]",f,b);void 0!=e&&e(b)};1==f.length?b.one("/api/"+f[0],c).remove().then(k,function(a){g(a)}):b.all("/api/"+f[0]).one(f[1],c).remove().then(k,function(a){g(a)})},put:function(f,c,e,g){var k=function(b){b=d.plain(b);a.debug("[PUT]",f,b);void 0!=e&&e(b)};1==f.length?
b.one("/api/"+f[0],c.id).customPUT(c).then(k,function(a){g(a)}):b.all("/api/"+f[0]).one(f[1],c.id).customPUT(c).then(k,function(a){g(a)})},post:function(f,c,e,g){var k=function(b){b=d.plain(b);a.debug("[POST]",f,b);void 0!=e&&e(b)};1==f.length?b.all("/api/"+f[0]).post(c).then(k,function(a){g(a)}):b.all("/api/"+f[0]).all(f[1]).post(c).then(k,function(a){g(a)})},task:function(f,c,e,g,k,l){var q=function(b){var c=d.plain(b);a.debug("[TASK]",b,f,c);void 0!=k&&k(c)};1==f.length?b.all("/api/"+f[0]).one(c).customPOST(g,
"",{task:e}).then(q,function(a){l(a)}):b.all("/api/"+f[0]).all(f[1]).one(c).customPOST(g,"",{task:e}).then(q,function(a){l(a)})}},g={findAll:function(c,e,g,m,k,l){var q=function(b){var l=[];_.forEach(b,function(a){l.push(d.plain(a))});a.debug("[FIND/L/"+g+"]",c,e,m,l);k(l)};1==e.length?1==c.length?b.one("/api/"+c[0],m).all(e[0]).getList({href:g}).then(q,function(a){l(a)}):b.all("/api/"+c[0]).one(c[1],m).all(e[0]).getList({href:g}).then(q,function(a){l(a)}):1==c.length?b.one("/api/"+c[0],m).all(e[0]).all(e[1]).getList({href:g}).then(q,
function(a){l(a)}):b.all("/api/"+c[0]).one(c[1],m).all(e[0]).all(e[1]).getList({href:g}).then(q,function(a){l(a)})},post:function(c,e,g,m,k,l,q,p){var r=function(b){b=d.plain(b);a.debug("[POST/L]",c,b);void 0!=q&&q(b)};void 0!=l&&(l.href=g);1==e.length?1==c.length?b.one("/api/"+c[0],m).one(e[0],k).customPOST(l).then(r,function(a){p(a)}):b.all("/api/"+c[0]).one(c[1],m).one(e[0],k).customPOST(l).then(r,function(a){p(a)}):1==c.length?b.one("/api/"+c[0],m).all(e[0]).one(e[1],k).customPOST(l).then(r,function(a){p(a)}):
b.all("/api/"+c[0]).one(c[1],m).all(e[0]).one(e[1],k).customPOST(l).then(r,function(a){p(a)})},put:function(c,e,g,m,k,l,q,p,r){var t=function(b){b=d.plain(b);a.debug("[PUT/L]",c,b);void 0!=p&&p(b)},s={},s=void 0===q?{}:q;s.href=g;1==e.length?1==c.length?b.one("/api/"+c[0],m).one(e[0],k).one(l).customPUT(s).then(t,function(a){r(a)}):b.all("/api/"+c[0]).one(c[1],m).one(e[0],k).one(l).customPUT(s).then(t,function(a){r(a)}):1==c.length?b.one("/api/"+c[0],m).all(e[0]).one(e[1],k).one(l).customPUT(s).then(t,
function(a){r(a)}):b.all("/api/"+c[0]).one(c[1],m).all(e[0]).one(e[1],k).one(l).customPUT(s).then(t,function(a){r(a)})},delete:function(c,e,g,m,k,l,q,p){var r=function(b){b=d.plain(b);a.debug("[DELETE/L]",c,b);void 0!=q&&q(b)};1==e.length?1==c.length?b.one("/api/"+c[0],m).one(e[0],k).remove({instance:l,href:g}).then(r,function(a){p(a)}):b.all("/api/"+c[0]).one(c[1],m).one(e[0],k).remove({instance:l,href:g}).then(r,function(a){p(a)}):1==c.length?b.one("/api/"+c[0],m).all(e[0]).one(e[1],k).remove({instance:l,
href:g}).then(r,function(a){p(a)}):b.all("/api/"+c[0]).one(c[1],m).all(e[0]).one(e[1],k).remove({instance:l,href:g}).then(r,function(a){p(a)})}};return{crud:function(a){return{findAll:function(b,c){return e.findAll(a,b,c)},get:function(b,c,d){return e.get(a,b,c,d)},delete:function(b,c,d){return e.delete(a,b,c,d)},put:function(b,c,d){return e.put(a,b,c,d)},post:function(b,c,d){return e.post(a,b,c,d)},task:function(b,c,d,g,l){return e.task(a,b,c,d,g,l)}}},links:function(a,b,c){void 0===c&&(c="HREF");
return{findAll:function(d,e,l){return g.findAll(a,b,c,d,e,l)},delete:function(d,e,l,q,p){return g.delete(a,b,c,d,e,l,q,p)},put:function(d,e,l,q,p,r){return g.put(a,b,c,d,e,l,q,p,r)},post:function(d,e,l,q,p){return g.post(a,b,c,d,e,l,q,p)}}},scope:{collections:{new:function(b,d,e,g,k){g.post(e,function(c){a.debug(b+" "+c.name+"#"+c.id+" created");d.push(c);k&&k(c)},c.failure)},findAll:function(b,d,e,g,k){a.debug("loading ",b,g);e.splice(0,e.length);g.findAll(d,function(c){_.forEach(c,function(a){e.push(a)});
...
angular.module("JarvisApp.services.scope",["JarvisApp.services.generic"]).factory("genericScopeService",["$log","$filter","genericResourceService","genericPickerService","toastService",function(a,b,d,c,e){return{scope:{resources:function(g,f,h,n,m,k){a.debug("inject default resources scope",n,k);h.create=function(a,b){d.scope.collections.new(n,f(),a,m,b)};h.new=function(a){d.scope.collections.new(n,f(),k,m,a)};h.crud=d.crud(n.split("/"));h.remove=function(d,e){c.pickers.confirm(b("translate")("action.drop",
{name:d.name,id:d.id}),"",b("translate")("yes"),b("translate")("no")).then(function(){a.debug("remove",d);var b=d.id;_.remove(f(),function(a){return a.id==b});h.crud.delete(d.id);e&&e(d)},function(){a.debug("abort")})};h.load=function(b){g([]);m.findAll(function(d){g(d);a.debug(n+"-ctrl",d,b);b&&b()},e.failure)}},resource:function(e,f,h,n,m,k,l){a.debug("inject default resource scope",f);e.remove=function(k){c.pickers.confirm(b("translate")("action.drop",{name:k.name,id:k.id}),"",b("translate")("yes"),
b("translate")("no")).then(function(){d.scope.entity.remove(function(){e.go(h)},f,k,n)},function(){a.debug("abort")})};e.save=function(a){d.scope.entity.save(f,a,n)};e.duplicate=function(a){d.scope.entity.duplicate(function(){e.go(h)},f,a,n)}},resourceLink:function(e,f,h,n,m,k,l,q,p){a.debug("inject link",k);f.add=function(b){a.debug("link::add",b);d.scope.link.add(q,b,l,k,e())};f.update=function(b){a.debug("link::update",b);d.scope.link.save(q,b,k)};f.drop=function(f){c.pickers.confirm(b("translate")("action.remove.link",
{name:f.name,id:f.id}),"",b("translate")("yes"),b("translate")("no")).then(function(){a.debug("link::drop",f);p&&p.remove?p.remove(f):d.scope.link.remove(q,f,k,e());p&&p.afterRemove&&p.afterRemove(f)},function(){a.debug("abort")})}}}}}]);"use strict";
angular.module("JarvisApp.services.plugin",[]).factory("pluginResourceService",["$log","Restangular","filterService","jarvisWidgetCommandService","genericResourceService",function(a,b,d,c,e){return{plugins:{findAll:function(a,c){var e=[],n=["scripts"],m=_.after(n.length,function(b){a(b)});_.forEach(n,function(a){b.all("plugins").all(a).getList().then(function(a){_.forEach(a,function(a){e.push(d.plain(a))});m(e)},function(a){c(a)})})}},scripts:e.crud(["plugins","scripts"]),commands:e.links(["plugins",
"scripts"],["commands"])}}]);"use strict";angular.module("JarvisApp.services.view",[]).factory("viewResourceService",["genericResourceService",function(a){return{view:a.crud(["views"]),devices:a.links(["views"],["devices"])}}]);"use strict";angular.module("JarvisApp.services.property",[]).factory("propertyResourceService",["genericResourceService",function(a){return{property:a.crud(["properties"])}}]);"use strict";
angular.module("JarvisApp.services.snapshot",[]).factory("snapshotResourceService",["genericResourceService",function(a){return{snapshot:a.crud(["snapshots"])}}]);"use strict";angular.module("JarvisApp.services.device",[]).factory("deviceResourceService",["genericResourceService",function(a){return{device:a.crud(["devices"]),plugins:a.links(["devices"],["plugins","scripts"]),devices:a.links(["devices"],["devices"]),triggers:a.links(["devices"],["triggers"])}}]);"use strict";
angular.module("JarvisApp.services.event",[]).factory("eventResourceService",["genericResourceService",function(a){return{event:a.crud(["events"])}}]);"use strict";angular.module("JarvisApp.services.scenario",[]).factory("scenarioResourceService",["genericResourceService",function(a){return{scenario:a.crud(["scenarios"]),blocks:a.links(["scenarios"],["blocks"]),triggers:a.links(["scenarios"],["triggers"])}}]);"use strict";
...
"use strict";
angular.module("JarvisApp.config",["JarvisApp.directives.files"]).config(["RestangularProvider",function(a){a.setDefaultHeaders({"content-type":"application/json"});a.setFullRequestInterceptor(function(a,d,c,e,g,f,h){g["content-type"]="application/json";return{element:a,params:f,headers:g,httpConfig:h}});a.setResponseExtractor(function(a){angular.isObject(a)&&(a.originalElement=a);return a})}]).config(["$mdIconProvider",function(a){}]).config(["$translateProvider",function(a){a.useStaticFilesLoader({prefix:"js/l10n/",suffix:".json"});
a.preferredLanguage("fr_FR");a.useSanitizeValueStrategy(null)}]).controller("JarvisAppCtrl",["$rootScope","$scope","$log","$store","$notification","$http","$mdDialog","$mdSidenav","$mdMedia","$location","$window","$state","genericPickerService","toastService","deviceResourceService","eventResourceService","jarvisWidgetConfigurationService","oauth2ResourceService",function(a,b,d,c,e,g,f,h,n,m,k,l,q,p,r,t,s,u){b.isJson=function(a){try{JSON.parse(a)}catch(b){return!1}return!0};b.defaultValue=function(a,
b){return void 0===a?b:a};b.loadSettings=function(){s.configuration.findAll(function(a){(a=_.find(a,"active"))?b.config=a:p.failure("No default settings")},p.failure)};b.saveSettings=function(){s.configuration.put(b.config,function(a){d.info("Updated",a)},p.failure)};b.closeSettings=function(){f.hide()};b.settings=function(a){var c=n("sm")||n("xs");f.show({scope:b,preserveScope:!0,templateUrl:"js/partials/dialog/settingsDialog.tmpl.html",parent:angular.element(document.body),targetEvent:a,clickOutsideToClose:!0,
fullscreen:c}).then(function(){d.warn("Saving settings")},function(){d.warn("Cancel settings save")})};b.markdown=new showdown.Converter({tables:"true",ghCodeBlocks:"true"});b.helper=function(a){d.debug("State",l.current.name);g.get("js/helps/fr/"+l.current.name+".markdown").then(function(a){a=b.markdown.makeHtml(a.data);b.help={content:a.replace(/<table>/g,'\x3ctable class\x3d"table table-striped table-bordered table-hover"\x3e')};d.debug("Help",b.help);h("right").toggle()})};b.toggleSidenav=function(a){h(a).toggle()};
b.location=function(a,b){h(a).toggle();m.path(b)};b.go=function(a,b){l.go(a,b)};b.emit=function(a,b){d.debug("JarvisAppCtrl::emit",a,b,a.trigger);t.event.post({trigger:a.trigger,timestamp:(new Date).toISOString(),fired:!0,number:b},function(a){d.debug("JarvisAppCtrl::emit",a);p.info("event "+a.trigger+"#"+a.id+" emitted")},p.failure)};b.execute=function(a){r.device.task(a.id,"execute",{},function(a){d.debug("JarvisAppCtrl::execute",a);b.renderdata=a},p.failure)};b.graph=function(a,b){return q.pickers.graph(a,
b,function(a){d.debug("Go")},function(){d.debug("Abort")},"graphDialogCtrl")};b.$watch(function(a,b,d){return c.collection},function(a,d,c){b.store=a});b.boot=function(){b.config={};b.version={angular:angular.version,angularmd:window.ngMaterial};d.info("JarvisAppCtrl",b.version);b.media=n("xs");b.$watch(function(){return n("xs")},function(a){a&&(b.media="xs")});b.$watch(function(){return n("gt-xs")},function(a){a&&(b.media="gt-xs")});b.$watch(function(){return n("sm")},function(a){a&&(b.media="sm")});
b.$watch(function(){return n("gt-sm")},function(a){a&&(b.media="gt-sm")});b.$watch(function(){return n("md")},function(a){a&&(b.media="md")});b.$watch(function(){return n("gt-md")},function(a){a&&(b.media="gt-md")});b.$watch(function(){return n("lg")},function(a){a&&(b.media="lg")});b.$watch(function(){return n("gt-lg")},function(a){a&&(b.media="gt-lg")});b.$watch(function(){return n("xl")},function(a){a&&(b.media="xl")});b.$watch(function(){return n("print")},function(a){a&&(b.media="print")});hljs.initHighlightingOnLoad();
b.loadSettings();d.info("JarvisAppCtrl configured")};u.connect(b)}]).controller("extractTokenCtrl",["$scope","$log","$location","$rootScope","$state","oauth2ResourceService",function(a,b,d,c,e,g){b.warn("extractTokenCtrl",e);b=d.path().substr(1).split("\x26");c={};for(e=0;e<b.length;e++){var f=b[e].split("\x3d"),h=f[0];c[h]=f[1];"access_token"===h&&(g.connect(a,c.access_token),d.path("/home"))}}]).controller("oauth2DialogCtrl",["$scope","$window","$log","$mdDialog","oauth2ResourceService",function(a,
b,d,c,e){a.hide=function(){c.hide()};a.cancel=function(){c.cancel()};a.answer=function(a){e.config({client:a.client,oauth2_redirect_uri:b.location.href.split("#")[0]},function(a){d.info("JarvisAppCtrl configured with",a);b.location.href=a.url},function(a){d.warn("no oauth2 configuration",a)});c.hide()}}]).controller("graphDialogCtrl",["$scope","$log","$mdDialog",function(a,b,d){b.info("graphDialogCtrl");a.hide=function(){d.hide()};a.cancel=function(){d.cancel()};a.answer=function(a){d.hide(a)}}]).controller("pickPluginDialogCtrl",
...
templateUrl:"/ui/js/directives/navigator/jarvis-widget-navigator.html"}).state("helper-scenarii",{url:"/helper-scenarii",params:{resources:["triggers","crons","scenarios","blocks","plugins"]},controller:"jarvisWidgetNavigatorCtrl",templateUrl:"/ui/js/directives/navigator/jarvis-widget-navigator.html"}).state("helper-system",{url:"/helper-system",params:{resources:["configurations","notifications","properties","connectors","views"]},controller:"jarvisWidgetNavigatorCtrl",templateUrl:"/ui/js/directives/navigator/jarvis-widget-navigator.html"}).state("events",
{url:"/events",controller:"eventsCtrl",templateUrl:"/ui/js/partials/events/page.html"}).state("triggers",{url:"/triggers",controller:"triggersCtrl",templateUrl:"/ui/js/directives/trigger/jarvis-widget-triggers.html"}).state("triggers-by-id",{url:"/triggers/:id?tab",controller:"triggerCtrl",templateUrl:"/ui/js/directives/trigger/jarvis-widget-trigger.html"}).state("notifications",{url:"/notifications",controller:"notificationsCtrl",templateUrl:"/ui/js/directives/notification/jarvis-widget-notifications.html"}).state("notifications-by-id",
{url:"/notifications/:id?tab",controller:"notificationCtrl",templateUrl:"/ui/js/directives/notification/jarvis-widget-notification.html"}).state("devices",{url:"/devices",controller:"devicesCtrl",templateUrl:"/ui/js/partials/devices/page.html"}).state("devices-by-id",{url:"/devices/:id?tab",controller:"deviceCtrl",templateUrl:"/ui/js/partials/devices/device/page.html"}).state("plugins",{url:"/plugins",controller:"pluginsCtrl",templateUrl:"/ui/js/partials/plugins/page.html"}).state("plugins-by-id-script",
{url:"/plugins/scripts/:id?tab",controller:"pluginScriptCtrl",templateUrl:"/ui/js/partials/plugins/script/page.html"}).state("commands",{url:"/commands",controller:"commandsCtrl",template:"\x3cjarvis-widget-commands\x3e\x3c/jarvis-widget-commands\x3e"}).state("commands-by-id",{url:"/commands/:id",controller:"commandCtrl",template:"\x3cjarvis-widget-command\x3e\x3c/jarvis-widget-command\x3e"}).state("views",{url:"/views",controller:"viewsCtrl",templateUrl:"/ui/js/partials/views/page.html"}).state("views-by-id",
{url:"/views/:id",controller:"viewCtrl",templateUrl:"/ui/js/partials/views/view/page.html"}).state("configurations",{url:"/configurations",controller:"configurationsCtrl",templateUrl:"/ui/js/directives/configuration/jarvis-widget-configurations.html"}).state("configurations-by-id",{url:"/configurations/:id",controller:"configurationCtrl",templateUrl:"/ui/js/directives/configuration/jarvis-widget-configuration.html"}).state("properties",{url:"/properties",controller:"propertiesCtrl",templateUrl:"/ui/js/partials/properties/page.html"}).state("properties-by-id",
{url:"/properties/:id",controller:"propertyCtrl",templateUrl:"/ui/js/partials/properties/property/page.html"}).state("connectors",{url:"/connectors",controller:"connectorsCtrl",template:"\x3cjarvis-widget-connectors\x3e\x3c/jarvis-widget-connectors\x3e"}).state("connectors-by-id",{url:"/connectors/:id",controller:"connectorCtrl",template:"\x3cjarvis-widget-connector\x3e\x3c/jarvis-widget-connector\x3e"}).state("snapshots",{url:"/snapshots",controller:"snapshotsCtrl",templateUrl:"/ui/js/partials/snapshots/page.html"}).state("snapshots-by-id",
{url:"/snapshots/:id",controller:"snapshotCtrl",templateUrl:"/ui/js/partials/snapshots/snapshot/page.html"}).state("crons",{url:"/crons",controller:"cronsCtrl",template:"\x3cjarvis-widget-crons\x3e\x3c/jarvis-widget-crons\x3e"}).state("crons-by-id",{url:"/crons/:id",controller:"cronCtrl",template:"\x3cjarvis-widget-cron\x3e\x3c/jarvis-widget-cron\x3e"}).state("scenarios",{url:"/scenarios",controller:"scenariosCtrl",templateUrl:"/ui/js/partials/scenarios/page.html"}).state("scenarios-by-id",{url:"/scenarios/:id?tab",
controller:"scenarioCtrl",templateUrl:"/ui/js/partials/scenarios/scenario/page.html"}).state("blocks",{url:"/blocks",controller:"blocksCtrl",templateUrl:"/ui/js/partials/blocks/page.html"}).state("blocks-by-id",{url:"/blocks/:id?tab",controller:"blockCtrl",templateUrl:"/ui/js/partials/blocks/block/page.html"})}]);"use strict";
...
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/events/jarvis-events.html",link:function(b,c,e){a.debug("jarvis-devices")}}}]).directive("jarvisViews",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/views/jarvis-views.html",link:function(b,c,e){a.debug("jarvis-views")}}}]).directive("jarvisView",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/views/view/jarvis-view-general.html",link:function(b,
c,e){a.debug("jarvis-view")}}}]).directive("jarvisProperties",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/properties/jarvis-properties.html",link:function(b,c,e){a.debug("jarvis-properties")}}}]).directive("jarvisProperty",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/properties/property/jarvis-property-general.html",link:function(b,c,e){a.debug("jarvis-property")}}}]).directive("jarvisSnapshots",["$log","$stateParams",
function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/snapshots/jarvis-snapshots.html",link:function(b,c,e){a.debug("jarvis-snapshots")}}}]).directive("jarvisSnapshot",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/snapshots/snapshot/jarvis-snapshot-general.html",link:function(b,c,e){a.debug("jarvis-snapshot")}}}]).directive("jarvisScenarios",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/scenarios/jarvis-scenarios.html",
link:function(b,c,e){a.debug("jarvis-scenarios")}}}]).directive("jarvisScenario",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/scenarios/scenario/jarvis-scenario-general.html",link:function(b,c,e){a.debug("jarvis-scenario")}}}]).directive("jarvisScenarioBlocks",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/scenarios/scenario/jarvis-scenario-blocks.html",link:function(b,c,e){a.debug("jarvis-scenario-blocks")}}}]).directive("jarvisScenarioBlock",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/scenarios/scenario/jarvis-scenario-block.html",link:function(b,c,e){a.debug("jarvis-scenario-block")}}}]).directive("jarvisScenarioGraph",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/scenarios/scenario/jarvis-scenario-graph.html",link:function(b,c,e){a.debug("jarvis-scenario-graph")}}}]).directive("jarvisScenarioConsole",["$log","$stateParams",function(a,b){return{restrict:"E",
templateUrl:"/ui/js/partials/scenarios/scenario/jarvis-scenario-console.html",link:function(b,c,e){a.debug("jarvis-scenario-console")}}}]).directive("jarvisBlocks",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/blocks/jarvis-blocks.html",link:function(b,c,e){a.debug("jarvis-blocks")}}}]).directive("jarvisBlock",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/blocks/block/jarvis-block-general.html",link:function(b,c,e){a.debug("jarvis-block")}}}]).directive("jarvisBlockThen",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/blocks/block/jarvis-block-then.html",link:function(b,c,e){a.debug("jarvis-block-then")}}}]).directive("jarvisBlockElse",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/blocks/block/jarvis-block-else.html",link:function(b,c,e){a.debug("jarvis-block-else")}}}]).directive("jarvisHome",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/home/jarvis-home.html",
link:function(b,c,e){a.debug("jarvis-home")}}}]).directive("jarvisCard",["$log","$parse",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/widget/tile/jarvis-card.html",scope:!1,link:function(d,c,e){a.debug("jarvis-card element",b(e.element)(d));a.debug("jarvis-card state",b(e.state)(d));d.element=b(e.element)(d);d.state=b(e.state)(d)}}}]).directive("jarvisTile",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/widget/tile/jarvis-tile.html",link:function(b,
c,e){a.debug("jarvis-tile")}}}]).directive("jarvisTileBoolean",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/widget/tile/jarvis-tile-boolean.html",link:function(b,c,e){a.debug("jarvis-tile-boolean")}}}]).directive("jarvisTileInt",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/partials/widget/tile/jarvis-tile-int.html",link:function(b,c,e){a.debug("jarvis-tile-int")}}}]).directive("jarvisTilePercent",["$log","$stateParams",function(a,
b){return{restrict:"E",templateUrl:"/ui/js/partials/widget/tile/jarvis-tile-percent.html",link:function(b,c,e){a.debug("jarvis-tile-percent")}}}]).directive("jarvisInlineTemplate",["$log","$stateParams","$parse",function(a,b,d){return{restrict:"E",template:'\x3cdiv ng-include\x3d"getJarvisInlineTemplateUrl()"\x3e\x3c/div\x3e',link:function(b,e,g){a.debug("jarvis-inline-template id",d(g.id)(b));b.getJarvisInlineTemplateUrl=function(){b.data=d(g.data)(b);return"/api/directives/html/devices/"+d(g.id)(b)}}}}]).directive("jarvisGauge",
["$log","$store","$notification",function(a,b,d){return{restrict:"AC",controller:["$scope","$element","$attrs",function(c,e,d){a.debug("jarvis-gauge",d.id);c.gauge=(new Gauge(document.getElementById(d.id))).setOptions({fontSize:10,lines:10,angle:0,lineWidth:.32,pointer:{length:.9,strokeWidth:.035,color:"#000000"},limitMax:"false",colorStart:"#6FADCF",colorStop:"#8FC0DA",strokeColor:"#E0E0E0",generateGradient:!0});c.gauge.maxValue=100;c.gauge.animationSpeed=10;c.gauge.set(0);c.$watch(function(){return 100*
b.get("SystemIndicator","1",0).systemCpuLoad},function(a,b,d){c.gauge.set(a)})}]}}]);"use strict";
angular.module("jarvis.directives.cron",["JarvisApp.services"]).controller("cronsCtrl",["$scope","$log","genericScopeService","jarvisWidgetCronService","toastService",function(a,b,d,c,e){d.scope.resources(function(b){a.crons=b},function(){return a.crons},a,"crons",c.cron,{name:"cron name",icon:"list",cron:"* * * * *"});a.start=function(){_.each(a.crons,function(a){c.cron.task(a.id,"toggle",{target:!0},function(a){e.info("crontab "+crontab.name+"#"+crontab.id+" toggled to "+crontab.status)},e.failure)})};
a.stop=function(){_.each(a.crons,function(a){c.cron.task(a.id,"toggle",{target:!1},function(a){e.info("crontab "+crontab.name+"#"+crontab.id+" toggled to "+crontab.status)},e.failure)})}}]).controller("cronCtrl",["$scope","$log","$stateParams","$filter","$http","genericResourceService","genericScopeService","jarvisWidgetCronService","deviceResourceService","toastService",function(a,b,d,c,e,g,f,h,n,m){f.scope.resource(a,"cron","crons",h.cron);a.toggle=function(a){b.info(a);h.cron.task(a.id,"toggle",
{},function(a){m.info("crontab "+crontab.name+"#"+crontab.id+" toggled to "+crontab.status)},m.failure)};a.test=function(a){b.info(a);h.cron.task(a.id,"test",{},function(a){m.info("crontab "+crontab.name+"#"+crontab.id+" toggled to "+crontab.status)},m.failure)};a.load=function(){a.crons=[];g.scope.entity.get(d.id,function(b){a.cron=b},h.cron);b.info("cron-ctrl",a.crons)}}]).factory("jarvisWidgetCronService",["genericResourceService",function(a){return{cron:a.crud(["crons"])}}]).directive("jarvisWidgetCrons",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/cron/jarvis-widget-crons.html",link:function(a,b,e){}}}]).directive("jarvisCrons",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/cron/partials/jarvis-crons.html",link:function(a,b,e){}}}]).directive("jarvisWidgetCron",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/cron/jarvis-widget-cron.html",link:function(a,b,e){}}}]).directive("jarvisCron",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/cron/partials/jarvis-cron-general.html",link:function(b,c,e){a.debug("jarvis-command")}}}]);
...
["$scope","$log","$stateParams","$mdDialog","genericResourceService","genericScopeService","jarvisWidgetConfigurationService","toastService",function(a,b,d,c,e,g,f,h){g.scope.resource(a,"configuration","configurations",f.configuration);a.load=function(){e.scope.entity.get(d.id,function(b){a.config=b},f.configuration);b.info("configuration-ctrl",a.configurations)}}]).factory("jarvisWidgetConfigurationService",["genericResourceService",function(a){return{configuration:a.crud(["configurations"])}}]).directive("jarvisWidgetConfigurations",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/configuration/jarvis-widget-configurations.html",link:function(a,b,e){}}}]).directive("jarvisConfigurations",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/configuration/partials/jarvis-configurations.html",link:function(b,c,e){a.debug("jarvis-configurations")}}}]).directive("jarvisWidgetConfiguration",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/configuration/jarvis-widget-configuration.html",
link:function(a,b,e){}}}]).directive("jarvisConfiguration",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/configuration/partials/jarvis-configuration-general.html",link:function(b,c,e){a.debug("jarvis-configuration")}}}]).directive("jarvisConfigurationSystem",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/configuration/partials/jarvis-configuration-system.html",link:function(b,c,e){a.debug("jarvis-configuration-system")}}}]);
"use strict";
angular.module("jarvis.directives.connector",["JarvisApp.services"]).controller("connectorsCtrl",["$scope","$log","genericScopeService","jarvisWidgetConnectorService",function(a,b,d,c){d.scope.resources(function(b){a.connectors=b},function(){return a.connectors},a,"connectors",c.connector,{name:"connector name",icon:"settings_input_antenna",isRenderer:!1,isSensor:!1,canAnswer:!1})}]).controller("connectorCtrl",["$scope","$log","$stateParams","$mdDialog","genericResourceService","genericScopeService","jarvisWidgetConnectorService",
"toastService",function(a,b,d,c,e,g,f,h){g.scope.resource(a,"connector","connectors",f.connector);a.ping=function(b){f.connector.task(b.id,"ping",b,function(b){a.status=angular.toJson(b,!0)},h.failure)};a.load=function(){e.scope.entity.get(d.id,function(b){a.connector=b},f.connector);b.info("connector-ctrl",a.connectors)}}]).factory("jarvisWidgetConnectorService",["genericResourceService",function(a){return{connector:a.crud(["connectors"])}}]).directive("jarvisWidgetConnectors",["$log","$stateParams",
function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/jarvis-widget-connectors.html",link:function(a,b,e){}}}]).directive("jarvisConnectors",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/partials/jarvis-connectors.html",link:function(a,b,e){}}}]).directive("jarvisWidgetConnector",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/jarvis-widget-connector.html",link:function(a,b,e){}}}]).directive("jarvisConnectorGeneral",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/connector/partials/jarvis-connector-general.html",link:function(a,b,e){}}}]);
angular.module("jarvis.directives.navigator",["JarvisApp.services"]).controller("jarvisWidgetNavigatorCtrl",["$scope","$log","$stateParams",function(a,b,d){a.resources=d.resources;a.answer=function(a){a.callback(a)}}]).factory("jarvisWidgetNavigatorService",["$q","$location","snapshotResourceService","blockResourceService","jarvisWidgetConfigurationService","propertyResourceService","viewResourceService","jarvisWidgetTriggerService","scenarioResourceService","cronResourceService","jarvisWidgetConnectorService",
"jarvisWidgetCommandService","pluginResourceService","deviceResourceService",function(a,b,d,c,e,g,f,h,n,m,k,l,q,p){return{devices:function(){var c=a.defer();p.device.findAll(function(a){_.each(a,function(a){p.plugins.findAll(a.id,function(b){a.desc="";_.each(b,function(b){a.desc+=b.name})});a.selectable=!0;a.callback=function(a){b.path("/devices/"+a.id)};a.ext=angular.toJson(angular.fromJson(a.parameters),!0)});c.resolve({elements:a,title:"Devices",route:"/devices"})});return c.promise},plugins:function(){var c=
...
route:"/commands"})});return c.promise},snapshots:function(){var c=a.defer();d.snapshot.findAll(function(a){_.each(a,function(a){a.selectable=!0;a.callback=function(a){b.path("/snapshots/"+a.id)}});c.resolve({elements:a,title:"Snapshots",route:"/snapshots"})});return c.promise},blocks:function(){var e=a.defer();c.block.findAll(function(a){_.each(a,function(a){a.selectable=!0;a.callback=function(a){b.path("/blocks/"+a.id)}});e.resolve({elements:a,title:"Blocks",route:"/blocks"})});return e.promise},
...
"use strict";
angular.module("jarvis.directives.notification",["JarvisApp.services"]).controller("notificationsCtrl",["$scope","$log","genericScopeService","jarvisWidgetNotificationService",function(a,b,d,c){d.scope.resources(function(b){a.notifications=b},function(){return a.notifications},a,"notifications",c.notification,{name:"notification name",icon:"settings_remote"})}]).controller("notificationCtrl",["$scope","$log","$stateParams","genericResourceService","genericScopeService","genericPickerService","jarvisWidgetNotificationService",
"toastService",function(a,b,d,c,e,g,f,h){e.scope.resource(a,"notification","notifications",f.notification);a.test=function(a,b,c,d){f.notification.task(a.id,"test",{text:b,title:c,subtext:d},function(b){h.info("notification "+a.name+"#"+a.id+" tested")},h.failure)};a.load=function(){a.combo={types:f.types};c.scope.entity.get(d.id,function(b){a.notification=b},f.notification);b.info("notification-ctrl")}}]).factory("jarvisWidgetNotificationService",["genericResourceService",function(a){return{notification:a.crud(["notifications"]),
types:[{id:"SLACK",value:"notification.slack"},{id:"MAIL",value:"notification.mail"}]}}]).directive("jarvisNotifications",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/notification/partials/jarvis-notifications.html",link:function(a,b,e){}}}]).directive("jarvisNotification",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/notification/partials/jarvis-notification-general.html",link:function(a,b,e){}}}]).directive("jarvisNotificationTest",
["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/notification/partials/jarvis-notification-test.html",link:function(a,b,e){}}}]);"use strict";
angular.module("jarvis.directives.trigger",["JarvisApp.services"]).controller("triggersCtrl",["$scope","$log","genericScopeService","jarvisWidgetTriggerService",function(a,b,d,c){d.scope.resources(function(b){a.triggers=b},function(){return a.triggers},a,"triggers",c.trigger,{name:"trigger name",icon:"settings_remote"})}]).controller("triggerCtrl",["$scope","$log","$stateParams","genericResourceService","genericScopeService","genericPickerService","jarvisWidgetTriggerService","toastService",function(a,
b,d,c,e,g,f,h){e.scope.resource(a,"trigger","triggers",f.trigger);a.links={crons:{}};e.scope.resourceLink(function(){return a.crons},a.links.crons,"cron","crons",f.trigger,f.crons,{order:"1"},d.id);a.execute=function(a){f.trigger.task(a.id,"execute",{},function(b){h.info("trigger "+a.name+"#"+a.id+" executed")},h.failure)};a.load=function(){c.scope.entity.get(d.id,function(b){a.trigger=b},f.trigger);a.crons=[];c.scope.collections.findAll("crons",d.id,a.crons,f.crons);b.info("trigger-ctrl")}}]).factory("jarvisWidgetTriggerService",
["genericResourceService",function(a){return{trigger:a.crud(["triggers"]),crons:a.links(["triggers"],["crons"])}}]).directive("jarvisTriggers",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/trigger/partials/jarvis-triggers.html",link:function(b,c,e){a.debug("jarvis-triggers")}}}]).directive("jarvisTrigger",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/trigger/partials/jarvis-trigger-general.html",link:function(b,c,
e){a.debug("jarvis-trigger")}}}]).directive("jarvisTriggerCron",["$log","$stateParams",function(a,b){return{restrict:"E",templateUrl:"/ui/js/directives/trigger/partials/jarvis-trigger-cron.html",link:function(b,c,e){a.debug("jarvis-trigger-cron")}}}]);"use strict";
...
"render",{},function(c){b.debug("deviceCtrl::render",c);a.renderdata=c;a.output=angular.toJson(c,!0)},n.failure)};a.load=function(){a.activeTab=c.tab;h.scope.entity.get(c.id,function(b){a.device=b},e.device);a.plugins=[];h.scope.collections.findAll("plugins",c.id,a.plugins,e.plugins);a.devices=[];h.scope.collections.findAll("devices",c.id,a.devices,e.devices);a.triggers=[];h.scope.collections.findAll("triggers",c.id,a.triggers,e.triggers);b.info("device-ctrl")}}]);"use strict";
...
"jarvisWidgetCommandService","toastService",function(a,b,d,c,e,g,f,h,n,m){e.scope.resource(a,"script","plugins",f.scripts);a.links={commands:{}};e.scope.resourceLink(function(){return a.commands},a.links.commands,"script","plugins",f.scripts,f.commands,{order:"1",name:"noname",nature:"json",type:"data"},d.id);a.execute=function(c){void 0!=c&&void 0!=c.id&&""!=c.id&&f.scripts.task(c.id,"execute",a.rawTestData,function(d){b.debug("pluginScriptCtrl::execute",c,d);a.rawoutput=d;a.output=angular.toJson(d,
!0)},m.failure)};a.render=function(c){void 0!=c&&void 0!=c.id&&""!=c.id&&f.scripts.task(c.id,"render",a.rawTestData,function(d){b.debug("pluginScriptCtrl::render",c,d);a.rawoutput=d;a.output=angular.toJson(d,!0)},m.failure)};a.submit=function(){a.rawTestData=angular.fromJson(a.editTestData);a.jsonTestData=angular.toJson(a.rawTestData,!0)};a.clear=function(){a.rawoutput={};a.output=angular.toJson({},!0);a.rawTestData={};a.editTestData=angular.toJson(a.rawTestData,!0);a.jsonTestData=angular.toJson(a.rawTestData,
...
"toastService",function(a,b,d,c,e,g,f,h,n,m){f.scope.resource(a,"snapshot","snapshots",h.snapshot);a.restore=function(a){void 0!=a&&void 0!=a.id&&""!=a.id&&h.snapshot.task(a.id,"restore",{},function(c){b.debug("snapshotCtrl::restore",a,c)},m.failure)};a.download=function(a){void 0!=a&&void 0!=a.id&&""!=a.id&&h.snapshot.task(a.id,"download",{},function(d){var e="export-"+c("date")(new Date,"yyyyMMdd-HHmmss")+".json",f=document.createElement("a");document.body.appendChild(f);f.style="display: none";
b.debug("snapshot",a,d);d=new Blob([angular.toJson(d,!0)],{type:"application/text"});d=window.URL.createObjectURL(d);f.href=d;f.download=e;f.click()},m.failure)};a.upload=function(a){$("#"+a).trigger("click")};a.loaded=function(a,c){a.json=c.data;b.debug("loaded",a,c)};a.load=function(){a.snapshots=[];g.scope.entity.get(d.id,function(b){a.snapshot=b},h.snapshot);b.info("snapshot-ctrl",a.snapshots)}}]);"use strict";
...
"pluginResourceService","toastService",function(a,b,d,c,e,g,f,h,n,m,k){e.scope.resource(a,"scenario","scenarios",h.scenario);a.links={blocks:{},triggers:{}};e.scope.resourceLink(function(){return a.blocks},a.links.blocks,"scenario","scenarios",h.scenario,h.blocks,{order:"1"},d.id);e.scope.resourceLink(function(){return a.triggers},a.links.triggers,"scenario","scenarios",h.scenario,h.triggers,{order:"1"},d.id);a.build=function(a){var c=[];_.each(a,function(a){b.debug("graph",a.stage);var d="";_.each(a.nodes,
...
a.load=function(){a.activeTab=d.tab;a.plugin={};g.scope.entity.get(d.id,function(b){a.scenario=b;a.chart(b)},h.scenario);a.blocks=[];g.scope.collections.findAll("blocks",d.id,a.blocks,h.blocks,function(a){_.forEach(a,function(a){a.plugins={};a.plugins.if=[];a.plugins.then=[];a.plugins.else=[];n.plugins.if.findAll(a.id,function(b){a.plugins.if=b});n.plugins.then.findAll(a.id,function(b){a.plugins.then=b});n.plugins.else.findAll(a.id,function(b){a.plugins.else=b});a.blocks={};a.blocks.then=[];a.blocks.else=
[];n.blocks.then.findAll(a.id,function(b){a.blocks.then=b});n.blocks.else.findAll(a.id,function(b){a.blocks.else=b});b.debug("blocks.plugins",a.plugins);b.debug("blocks.blocks",a.blocks)})});a.triggers=[];g.scope.collections.findAll("triggers",d.id,a.triggers,h.triggers);b.debug("scenario-ctrl",a.scenario)}}]);"use strict";
