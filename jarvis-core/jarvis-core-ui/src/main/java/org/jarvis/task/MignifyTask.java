	...
	public static void main(String[] args) throws IOException {
		...
		Files.walkFileTree(FileSystems.getDefault().getPath(PATH), new FileVisitor<Path>() {
			...
			public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
				...
				if(filename.endsWith(".html") || filename.endsWith(".css")  || filename.endsWith(".json") || filename.endsWith(".markdown") || filename.contains(".min.js") || filename.contains("config.js")) {
