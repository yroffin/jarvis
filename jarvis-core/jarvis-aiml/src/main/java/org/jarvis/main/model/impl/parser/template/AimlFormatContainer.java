 ...
 * format container
 */
public abstract class AimlFormatContainer extends AimlElementContainer {

	protected Logger logger = LoggerFactory.getLogger(AimlFormatContainer.class);

	/**
	 * @param tag
	 */
	public AimlFormatContainer(String tag) {
		super(tag);
	}
