...
@Configuration
public class ApiDeviceResourcesTest {

	@Autowired
	private ApiDeviceResources apiDeviceResources;
	...
	public void testUml() throws IOException {
		...
		bean.name = "Device de test";
		GenericValue value = apiDeviceResources.doRealTask(bean, args, "uml");
