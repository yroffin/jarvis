 ...
 */
@Component
public class ApiHrefViewResources extends ApiHrefMapper<ViewRest,DeviceRest> {

	@PostConstruct
	protected
	void init() {
		super.init(ViewBean.class.getSimpleName(),DeviceBean.class.getSimpleName(),"devices");
	}
}
